...
import {CarouselImageViewer, FileUploader, MarkdownView, SliderInput} from "@/app/ui/";
  ...
  export default function AnalysisForm ({
        ...
        return(
          <div className="w-full flex flex-row justify-start items-center gap-3 rounded-md mt-4 h-8">
            ...
            <button
              ...
              className={`flex  items-center justify-center border-2 border-2 border-emerald-400 bg-emerald-700 text-sm ml-auto text-white font-semibold p-2 rounded-full shadow-md gap-2 ${loading || !email || analysis.chartUrls.length < 1? 'opacity-50' : 'opacity-100 hover:bg-emerald-500'}`}
    ...
    return (
      <div className="relative w-full max-w-[100%] flex flex-col border-2 border-neutral-400 dark:border-gray-700 text-sm md:text-md lg:text-lg shadow-md rounded-md mb-2 p-4" >
        ...
        <div className={`flex lg:flex-row flex-col justify-between items-center gap-16 my-4 ${analysis.output? 'pb-2' : 'pb-16'}`}>
