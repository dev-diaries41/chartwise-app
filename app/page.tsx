...
import UsageDashboard  from './ui/user/usage';
      ...
      />
       <div className="animate-fadeIn relative flex flex-col max-w-5xl w-full mx-auto items-center justify-center text-center  opacity-90 p-8">
        ...
        <div className="w-full z-[10] flex flex-col py-16 justify-center items-center">
          ...
          <Link
            href='/trader'
            className={`w-[80%] md:w-[60%] lg:w-[40%] h-12 md:h-16 lg:h-18 flex flex-row items-center gap-2 justify-center bg-emerald-700 hover:bg-emerald-500 border-2 border-emerald-400 text-gray-200 font-semibold p-2 rounded-full shadow-md text-lg md:text-xl lg:text-2xl mt-4 `}
          >
            {'Try for free'}
