        ...
        <div className="p-5">
          <div className="reactMarkDown lg:text-lg leading-relaxed">
            ...
            <p><strong>TL;DR;</strong> 
              ...
              <strong className="font-semibold">Team License:</strong> Use ChartWise collaboratively.</p>
            <p>This License Agreement ("Agreement") is entered into between FPF Labs, whose contact information is <a href="mailto:fpflabs@gmail.com">fpflabs@gmail.com</a>, and you, the user ("Licensee"), regarding the use of ChartWise (the "Product"). By accessing, downloading, or using the Product, Licensee agrees to be bound by the terms and conditions of this Agreement.</p>
            <h2 className="text-xl font-bold mt-6 mb-2">1. Grant of License</h2>
            <h3 className="text-lg font-semibold">1.1 Personal License</h3>
            <p>Subject to the terms and conditions of this Agreement, FPF Labs grants Licensee a non-exclusive, non-transferable, and non-sublicensable Personal License to use ChartWise for the following purposes:</p>
            <ul>
              <li>Use ChartWise individually for personal or commercial trading analysis.</li>
              <li>Create and manage unlimited projects.</li>
            </ul>
            <h3 className="text-lg font-semibold">1.2 Team License</h3>
            <p>Subject to the terms and conditions of this Agreement, FPF Labs grants Licensee a non-exclusive, non-transferable, and non-sublicensable Team License to use ChartWise for the following purposes:</p>
            <ul>
              <li>Use ChartWise collaboratively within a team environment.</li>
              <li>Create and manage unlimited projects.</li>
              <li>Share access to the tools with other team members.</li>
            </ul>
            <h2 className="text-xl font-bold mt-6 mb-2">2. Restrictions</h2>
            <p>Licensee shall not:</p>
            <ul>
              <li>Modify, adapt, reverse engineer, decompile, disassemble, or create derivative works based on ChartWise.</li>
              <li>Remove, alter, or obscure any copyright, trademark, or other proprietary notices from ChartWise.</li>
              <li>Use ChartWise in any way that violates applicable laws, regulations, or third-party rights.</li>
              <li>Sub-license, rent, lease, or transfer ChartWise or any rights granted under this Agreement.</li>
            </ul>
