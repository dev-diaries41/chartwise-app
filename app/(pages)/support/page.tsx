...
export default function Page () {
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center py-8 pt-24 px-4">
      <h1 className='text-center text-3xl my-4 px-3 font-bold'>Support</h1>
